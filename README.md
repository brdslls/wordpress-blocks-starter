...
1. scaffold block folder and files (or copy existing block)

## 3. Create new block
3. edit fields in block.json, edit.js, save.js
4. register block in functions.php (path to block.json file or to the directory with this file)
```php
